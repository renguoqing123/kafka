...
public class KafkaConsumerMessage {
    ...
    KafkaConsumerMessage() throws IOException {
        ...
        InputStream in = KafkaConsumerMessage.class.getClass().getResourceAsStream("/kafkaConsumer.Properties");
        props.load(in);
        ...
        try {
            while (true) {
                ...
                for (ConsumerRecord<Integer, String> record : records) {
                    System.out.printf("topic = %s,offset = %d, key = %s, value = %s", record.topic(), record.offset(),
